        ...
        <div className="container-fluid">
            ...
            <div className="row">
                ...
                <div className="col-md-6 footer-second-section-right">
                    <div className='footer-section-link'><a href='https://www.linkedin.com/in/vanshika-koshti-18a30814b/' target="_blank" rel="noopener noreferrer">LinkedIn</a><a>Facebook</a><a>Instagram</a><a href='https://github.com/vanshikakoshti' target="_blank" rel="noopener noreferrer">GitHub</a></div>
                </div>
