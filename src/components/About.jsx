...
export default function About() {
  return (
    <>
      <div className="bg-theme section-padding">
        <div className="container-fluid">
          ...
          <div className="row pt-5 align-items-center justify-content-between">
            <div className="col-md-3">
              <div className="project-counter"><p>Project complete</p><h3>80+</h3></div>
            </div>
            <div className="col-md-4">
              <div className="about-img"><img src={aboutus}/></div>
            </div>
            <div className="col-md-4">
              <p>I'm Vanshika Koshti I’m a passionate HTML Developer with a strong foundation in building clean, responsive, and accessible web pages. I specialize in writing semantic HTML5 code that ensures websites are both user-friendly and search-engine optimized.</p>
